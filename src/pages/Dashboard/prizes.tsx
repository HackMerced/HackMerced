            ...
            <ul className="dashboard__content__prizes__ul">
                <li className="dashboard__content__prizes__ul__li">
                    ...
                    <h4 className="dashboard__content__prizes__ul__li__body">
                        <b>1st Place </b> - Portable Projector for each member
                        <br></br> <br></br> <b>2nd Place </b> - Bento Stack for each member <br></br>
                        <br></br> <b>3rd Place</b> - $50 Amazon Gift Card for each member{" "}
                    </h4>
                </li>
                <li className="dashboard__content__prizes__ul__li">
                    <h3 className="dashboard__content__prizes__ul__li__title">Social Good</h3>
                    <h4 className="dashboard__content__prizes__ul__li__body">
                        <b>1st Place </b> - Beats Wireless Headphones for each member
                        <br></br> <br></br>
                        <b>2nd Place </b> - Samsung Tracking Smart Band for each member <br></br>
                        <br></br> <b>3rd Place</b> - Google Mini for each member{" "}
                    </h4>
                </li>
                <li className="dashboard__content__prizes__ul__li">
                    <h3 className="dashboard__content__prizes__ul__li__title">CyberSecurity</h3>
                    <h4 className="dashboard__content__prizes__ul__li__body">
                        <b>1st Place </b> - 5TB WD-Black External Hard Drive for each member
                        <br></br> <br></br> <b>2nd Place </b> - USB Rubber Ducky for each member <br></br>
                        <br></br> <b>3rd Place</b> - CanaKit Raspberry Pi 3 for each member{" "}
                    </h4>
                </li>
                <li className="dashboard__content__prizes__ul__li">
                    <h3 className="dashboard__content__prizes__ul__li__title">Moonshot</h3>
                    <h4 className="dashboard__content__prizes__ul__li__body">
                        <b>1st Place </b> - Moon Lamp Light for each member
                ...
                <li className="dashboard__content__prizes__ul__li">
                    ...
                    <h4 className="dashboard__content__prizes__ul__li__body">
                        <b>1st Place </b> - Sketch 1-year license for each member <br></br>
                        <br></br>
