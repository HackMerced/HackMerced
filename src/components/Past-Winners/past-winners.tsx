    ...
    return (
        <section className="PAST-WINNERS">
            ...
            <nav className="winners">
                <a href="https://devpost.com/software/helpers-spot" target="_blank">
                ...
                <a href="https://devpost.com/software/vibe-xja5cd" target="_blank">
                ...
                <a href="https://devpost.com/software/kabobcat" target="_blank">
                ...
                <a href="https://devpost.com/software/code-dude" target="_blank">
                ...
                <a href="https://devpost.com/software/snapcode-vabpfn" target="_blank">
                ...
                <a href="https://devpost.com/software/esose" target="_blank">
                ...
                <a href="https://devpost.com/software/3d-for-education" target="_blank">
                ...
                <a href="https://devpost.com/software/ghym">
                    <FontAwesomeIcon icon={faMeteor} className="fa winner-icon" target="_blank" />
                    <h5 className="winner-title">Moonshot</h5>
                    <h6 className="winner-group">Ghym</h6>
                </a>
                <a href="https://devpost.com/software/a-clear-space" target="_blank">
                ...
                <a href="https://devpost.com/software/project-dms" target="_blank">
