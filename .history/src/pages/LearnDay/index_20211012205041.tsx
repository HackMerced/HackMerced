        ...
        <main>
            ...
            <section className="grid-container">
                <div className="texts">
                    ...
                    <div className="h2">Learn to tackle new skills, explore different realms of technology, and champion exciting projects in a workshop event hosted by HackMerced on <strong>November 13, 2021.</strong></div>
